...
from tidyworld._llm import BaseEmbeddingService, DefaultEmbeddingService, DefaultLLMService
...
class TidyWorld(BaseTidyWorld[GTEmbedding, GTHash, GTChunk, GTNode, GTEdge, GTId]):
    ...
    class Config:
        ...
        def __post_init__(self):
            ...
            self.vector_storage.embedding_dim = self.embedding_service.embedding_dim
